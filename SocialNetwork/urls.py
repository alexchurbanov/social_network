...
from Accounts.views import (JWTObtainPairView, JWTRefreshView, LoginView,
                            logout_view, UsersViewSet)
...
urlpatterns = [
    ...
    path('api/v1/auth/jwt/refresh/', JWTRefreshView.as_view(), name='refresh_token'),
